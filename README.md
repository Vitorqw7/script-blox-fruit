...
local a = "https://raw.githubusercontent.com/Vitorqw7/script-blox-fruit/refs/heads/main/style"
...
function CheckQuest() 
    ...
    elseif World2 then
        ...
        elseif MyLevel == 975 or MyLevel <= 999 then
            ...
            NameMon = "Vampire"
            CFrameQuest = CFrame.new(-5497.06152, 47.5923004, -795.237061, -0.29242146, 0, -0.95628953, 0, 1, 0, 0.95628953, 0, -0.29242146)
            CFrameMon = CFrame.new(-6037.66796875, 32.18463897705078, -1340.659            Mon = "Monkey"
            LevelQuest = 1
            NameQuest = "JungleQuest"
            NameMon = "Monkey"
            CFrameQuest = CFrame.new(-1598.08911, 35.5501175, 153.377838, 0, 0, 1, 0, 1, -0, -1, 0, 0)
...
local Window = OrionLib:MakeWindow({Name = "Vitorqw7 - Exclusivo", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Vitorqw7 - Exclusivo"})

OrionLib:MakeNotification({
	Name = "Vitorqw7 - Exclusivo",
...
W:AddLabel("[+] Vitorqw7 - Exclusivo is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Vitorqw7 - Exclusivo(Noitification)",
